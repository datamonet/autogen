...
def init_db_samples(dbmanager: Any):
    ...
    generate_pdf_skill = Skill(
        ...
        user_id="curator@takin.ai", public=True,
    ...
    local_assistant = Agent(
        user_id="curator@takin.ai", public=True, type=AgentType.assistant,
    ...
    travel_groupchat_agent = Agent(
        user_id="curator@takin.ai", public=True, type=AgentType.groupchat,
    ...
    user_proxy = Agent(
        user_id="curator@takin.ai", public=True, type=AgentType.userproxy,
